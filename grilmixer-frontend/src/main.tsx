    ...
    <OrderAlertProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path="/foodcourt/category/:name"
            Component={FoodcourtCategory}
          />
          ...
          <Route
            path="/foodcourt/userAgreement"
            Component={FoodcourtAgreement}
          />
          <Route
            path="/foodcourt/thanks/:orderId"
            Component={FoodcourtThanks}
          />
